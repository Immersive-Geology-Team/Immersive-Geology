...
public class IGComplexItemModelProvider extends ModelProvider<TRSRModelBuilder>
{
	...
	protected void registerModels()
	{
		...
		generateBulkBlastFurnaceModel(IGMultiblockProvider.BULK_BLAST_FURNACE.block());
		generateFoundryModel(IGMultiblockProvider.FOUNDRY.block());
		...
		generateSmallChemicalReactor(IGMultiblockProvider.SMALL_CHEMICAL_REACTOR.block());
		generateAlternator(IGMultiblockProvider.ALTERNATOR.block());
	...
	private void generateSmallChemicalReactor(Supplier<? extends ItemLike> block)
	{
		...
		doTransform(trans, ItemDisplayContext.THIRD_PERSON_RIGHT_HAND, new Vector3f(1.0F, 0, -1.75F), new Vector3f(0, 270, 0), 0.03125F);
		doTransform(trans, ItemDisplayContext.HEAD, new Vector3f(0, 8, -8), null, 0.2F);
		doTransform(trans, ItemDisplayContext.GUI, new Vector3f(-1, -3.5f, 0), new Vector3f(30, 45, 0), 0.15F);
		doTransform(trans, ItemDisplayContext.GROUND, new Vector3f(-1.5F, 3, -1.5F), null, 0.1875F);
		doTransform(trans, ItemDisplayContext.FIXED, new Vector3f(-1, 0, -2), null, 0.0625F);
	}
	...
	private void generateGeothermalExchanger(Supplier<? extends ItemLike> block)
	{
		...
		doTransform(trans, ItemDisplayContext.THIRD_PERSON_RIGHT_HAND, new Vector3f(1.0F, 0, -1.75F), new Vector3f(0, 270, 0), 0.03125F);
		doTransform(trans, ItemDisplayContext.HEAD, new Vector3f(0, 8, -8), null, 0.2F);
		doTransform(trans, ItemDisplayContext.GUI, new Vector3f(0, 1, 0), new Vector3f(30, 45, 0), 0.16F);
		doTransform(trans, ItemDisplayContext.GROUND, new Vector3f(-1.5F, 3, -1.5F), null, 0.1875F);
		doTransform(trans, ItemDisplayContext.FIXED, new Vector3f(-1, 0, -2), null, 0.0625F);
	}
	...
	private void generateFoundryModel(Supplier<? extends ItemLike> block)
	{
		TRSRModelBuilder model = obj(block, "block/multiblock/obj/foundry/foundry.obj");
		ModelBuilder<?>.TransformsBuilder trans = model.transforms();
		doTransform(trans, ItemDisplayContext.FIRST_PERSON_LEFT_HAND, new Vector3f(-1.75F, 2.5F, 1.25F), new Vector3f(0, 225, 0), 0.03125F);
		doTransform(trans, ItemDisplayContext.FIRST_PERSON_RIGHT_HAND, new Vector3f(-1.75F, 2.5F, 1.75F), new Vector3f(0, 225, 0), 0.03125F);
		doTransform(trans, ItemDisplayContext.THIRD_PERSON_LEFT_HAND, new Vector3f(-0.75F, 0, -1.25F), new Vector3f(0, 90, 0), 0.03125F);
		doTransform(trans, ItemDisplayContext.THIRD_PERSON_RIGHT_HAND, new Vector3f(1.0F, 0, -1.75F), new Vector3f(0, 270, 0), 0.03125F);
		doTransform(trans, ItemDisplayContext.HEAD, new Vector3f(0, 8, -8), null, 0.2F);
		doTransform(trans, ItemDisplayContext.GUI, new Vector3f(0, -2, 0), new Vector3f(30, 225, 0), 0.115F);
		doTransform(trans, ItemDisplayContext.GROUND, new Vector3f(-1F, 3, -1F), null, 0.0625F);
		doTransform(trans, ItemDisplayContext.FIXED, new Vector3f(-1, -8, -2), null, 0.0625F);
	}

	private void generateBulkBlastFurnaceModel(Supplier<? extends ItemLike> block)
	{
		TRSRModelBuilder model = obj(block, "block/multiblock/obj/bulk_blast_furnace/bulk_blast_furnace.obj");
		model.texture("bulk_blast_furnace", "block/multiblock/bulk_blast_furnace/default");
		ModelBuilder<?>.TransformsBuilder trans = model.transforms();
		doTransform(trans, ItemDisplayContext.FIRST_PERSON_LEFT_HAND, new Vector3f(-1.5F, 2.5F, 1.25F), new Vector3f(0, 225, 0), 0.0625F);
		doTransform(trans, ItemDisplayContext.FIRST_PERSON_RIGHT_HAND, new Vector3f(-1.5F, 2.5F, 1.75F), new Vector3f(0, 225, 0), 0.0625F);
		doTransform(trans, ItemDisplayContext.THIRD_PERSON_LEFT_HAND, new Vector3f(-0.75F, 0, -1.25F), new Vector3f(0, 90, 0), 0.0625F);
		doTransform(trans, ItemDisplayContext.THIRD_PERSON_RIGHT_HAND, new Vector3f(1.0F, 0, -1.75F), new Vector3f(0, 270, 0), 0.0625F);
		doTransform(trans, ItemDisplayContext.HEAD, new Vector3f(0, 8, -8), null, 0.2F);
		doTransform(trans, ItemDisplayContext.GUI, new Vector3f(0, -3, 0), new Vector3f(30, 225, 0), 0.125F);
		doTransform(trans, ItemDisplayContext.GROUND, new Vector3f(-0.5F, 3, -0.5F), null, 0.0625F);
		doTransform(trans, ItemDisplayContext.FIXED, new Vector3f(-1, -8, -2), null, 0.0625F);
	}
}
