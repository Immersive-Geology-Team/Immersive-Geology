...
public class ModelChemicalVat extends IGModel{
    public static final String ID = "chemicalvatfan";
    public static final ResourceLocation TEXTURE = new ResourceLocation(IGLib.MODID, "textures/models/chemicalvat_fan.png");
