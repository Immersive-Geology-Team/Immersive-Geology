...
public class ImmersiveNetherBiomeProvider extends BiomeProvider
{
	/**
	...
	public ImmersiveNetherBiomeProvider(ImmersiveNetherGenSettings settings)
	{
		WorldInfo worldInfo = settings.getWorldInfo();
		List<IAreaFactory<LazyArea>> areaFactory = IGLayerUtil.createNetherBiomeLayer(worldInfo.getSeed(), settings);
