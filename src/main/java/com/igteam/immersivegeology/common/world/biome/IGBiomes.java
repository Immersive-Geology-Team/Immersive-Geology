...
import static com.igteam.immersivegeology.ImmersiveGeology.packetHandler;
...
public class IGBiomes
{
	...
	public static final IGBiome WARM_OCEAN = Helpers.getNull();
	public static final IGBiome COLD_OCEAN = Helpers.getNull();
	public static final IGBiome OCEAN_EDGE = Helpers.getNull();
	public static final IGBiome DEEP_OCEAN = Helpers.getNull();
	public static final IGBiome FROZEN_DEEP_OCEAN = Helpers.getNull();
	...
	private static final LazyLoadBase<Set<IGBiome>> BIOMES = new LazyLoadBase<>(() -> {
		...
		for(IGBiome biome : Arrays.asList(OCEAN,COLD_OCEAN,WARM_OCEAN, OCEAN_EDGE, DEEP_OCEAN,FROZEN_DEEP_OCEAN, DEEP_OCEAN_VOLCANIC, PLAINS, SWEDISH_FOREST, SNOWY_FOREST, DESERT, FROZEN_MOUNTAINS, GLACIER, MOUNTAIN_DUNES, ARCTIC_DESERT, HILLS, LOWLANDS, LOW_CANYONS, ROLLING_HILLS, BADLANDS, PLATEAU, OLD_MOUNTAINS, MOUNTAINS, FLOODED_MOUNTAINS, LUSH_MOUNTAINS, CANYONS, SHORE, STONE_SHORE, MOUNTAINS_EDGE, LAKE, OASIS, RIVER))
		{
			if(biome==null)
			{
