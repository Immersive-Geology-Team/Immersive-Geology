 ...
 * @since 22.08.2020
 */
public class MaterialTreatedWood extends MaterialWoodBase implements IHandleMaterial
{
	...
	public LinkedHashSet<ElementProportion> getElements()
	{
		return new LinkedHashSet<>(Arrays.asList(
				...
				new ElementProportion(PeriodicTableElement.CARBON, 6),
				new ElementProportion(PeriodicTableElement.HYDROGEN, 5),
				new ElementProportion(PeriodicTableElement.OXYGEN),
				new ElementProportion(PeriodicTableElement.HYDROGEN)
		));
	}
