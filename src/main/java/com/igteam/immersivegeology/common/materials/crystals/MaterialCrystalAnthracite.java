...
public class MaterialCrystalAnthracite extends MaterialCrystalBase
{
	@Override
	...
	public LinkedHashSet<ElementProportion> getElements()
	{
		return new LinkedHashSet<>(Arrays.asList(
				new ElementProportion(PeriodicTableElement.CARBON, 240),
				new ElementProportion(PeriodicTableElement.HYDROGEN, 90),
