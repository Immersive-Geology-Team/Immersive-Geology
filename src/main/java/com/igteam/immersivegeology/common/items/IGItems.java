...
public final class IGItems
{
    ...
    {
        //public static Map<EnumMinerals, Item> chucks = new EnumMap<>(EnumMinerals.class); //TODO add EnumMinerals
        //public static Map<EnumMinerals, Item> dusts = new EnumMap<>(EnumMinerals.class); //Should we have combined dusts that need seperating?
        //TODO Add things that match
    }
