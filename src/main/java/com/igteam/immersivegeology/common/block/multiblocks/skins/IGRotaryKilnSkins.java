...
public enum IGRotaryKilnSkins implements StringRepresentable, IIGMultiSkinHelper
{
	...
	IGRotaryKilnSkins(String s, ChatFormatting formatting, SkinCreditType type, String credit)
	{
		this.skin = s;
