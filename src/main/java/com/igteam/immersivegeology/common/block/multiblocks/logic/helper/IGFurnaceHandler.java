...
public class IGFurnaceHandler<R extends IESerializableRecipe>
{
	...
	public boolean tickServer(IMultiblockContext<? extends IGFurnaceHandler.IFurnaceEnvironment<R>> ctx, int furnaceIndex)
	{
		boolean active = false;
		final IGFurnaceHandler.IFurnaceEnvironment<R> env = ctx.getState();
