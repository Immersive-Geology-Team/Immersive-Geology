...
public class TurbineFuelBuilder  extends IEFinishedRecipe<TurbineFuelBuilder>
{
	...
	private TurbineFuelBuilder(TagKey<Fluid> fluid, float outputRatio, int burnTime) {
	...
	public static TurbineFuelBuilder builder(TagKey<Fluid> fluid, float outputRatio, int burnTime) {
		return new TurbineFuelBuilder(fluid, outputRatio, burnTime);
	}
}
