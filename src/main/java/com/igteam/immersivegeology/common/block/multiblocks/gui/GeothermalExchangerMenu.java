...
public class GeothermalExchangerMenu extends IEContainerMenu
{
	...
	{
		return new GeothermalExchangerMenu(clientCtx(type, id), invPlayer, new MutableEnergyStorage(GeothermalExchangerLogic.ENERGY_CAPACITY), GetterAndSetter.constant(0), GetterAndSetter.constant(0), GetterAndSetter.standalone(new byte[13]));
	}
