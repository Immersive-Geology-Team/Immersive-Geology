...
public class ChemicalReactorShape extends GenericShape {

    public static final ChemicalReactorShape GETTER = new ChemicalReactorShape();

    private ChemicalReactorShape(){};
