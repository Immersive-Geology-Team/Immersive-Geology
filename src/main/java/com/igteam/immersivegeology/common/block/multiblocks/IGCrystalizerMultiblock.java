...
public class IGCrystalizerMultiblock extends IGTemplateMultiblock
{
	...
	public IGCrystalizerMultiblock() {
        super(new ResourceLocation(IGLib.MODID, "multiblocks/crystallizer"), new BlockPos(1,0,1), new BlockPos(1,2,1), new BlockPos(3,3,3), IGMultiblockProvider.CRYSTALLIZER);
    }
