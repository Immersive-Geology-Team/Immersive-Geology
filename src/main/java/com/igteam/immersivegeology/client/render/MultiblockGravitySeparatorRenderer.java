...
public class MultiblockGravitySeparatorRenderer implements BlockEntityRenderer<GravitySeparatorTileEntity> {

    @Override
    public boolean shouldRenderOffScreen(@Nonnull GravitySeparatorTileEntity te){
        return true;
    }
    @Override
    public void render(GravitySeparatorTileEntity te, float partialTicks, PoseStack transform, MultiBufferSource buffer, int combinedLightIn, int combinedOverlayIn) {
