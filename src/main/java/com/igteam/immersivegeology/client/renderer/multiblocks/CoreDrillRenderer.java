...
import com.igteam.immersivegeology.common.block.multiblocks.part.CoreDrillPart;
...
@LinkedMultiSkin(multiblock = IGCoreDrillMultiblock.class)
public class CoreDrillRenderer extends IGBlockEntityRenderer<MultiblockBlockEntityMaster<CoreDrillLogic.State>>
{
    ...
    public void render(MultiblockBlockEntityMaster<CoreDrillLogic.State> tile, float pPartialTick, PoseStack poseStack, @NotNull MultiBufferSource buffer, int pPackedLight, int pPackedOverlay)
    {
        ...
        final IGCoreDrillSkins skin = tile.getBlockState().getValue(CoreDrillPart.COREDRILL);
        ...
        poseStack.pushPose();
            ...
            poseStack.pushPose();
                ...
                renderDynamicModel(DRILL_BIT, poseStack, buffer, Direction.NORTH, level, pos, pPackedLight, pPackedOverlay, skin);
            poseStack.popPose();
        poseStack.popPose();
        ...
        poseStack.pushPose();
            ...
            renderDynamicModel(DRILL_ENGINE, poseStack, buffer, dir, level, pos, pPackedLight, pPackedOverlay, skin);
            ...
            poseStack.pushPose();
                ...
                renderDynamicModel(DRILL_ENGINE_SUPPORT, poseStack, buffer, dir, level, pos, pPackedLight, pPackedOverlay, skin);
                ...
                poseStack.pushPose();
                    poseStack.pushPose();
                        ...
                        renderDynamicModel(DRILL_GEARSET, poseStack, buffer, Direction.NORTH, level, pos, pPackedLight, pPackedOverlay, skin);
                    poseStack.popPose();
