...
public class IGMenuTypes
{
	...
	public static final MultiblockContainer<FoundryLogic.State, FoundryMenu> FOUNDRY = registerMultiblock(IGLib.GUIID_Foundry, FoundryMenu::makeServer, FoundryMenu::makeClient);
