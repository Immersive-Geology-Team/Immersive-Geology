...
public class MaterialMolybdenite extends MaterialSulphideMineral
{
    ...
    public MaterialMolybdenite() {
        ...
        CONFIG = new MineralConfig(12,70,1,-64,212,1200, 0.75,false,Optional.of(BiomeTags.IS_NETHER), IGGenerationType.TUBE);
    }
    ...
    {
        return new LinkedHashSet<>(List.of(MetalEnum.Molybdenum, MetalEnum.Osmium, MetalEnum.Platinum));
    }
