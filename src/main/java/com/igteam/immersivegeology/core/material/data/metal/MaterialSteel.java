...
public class MaterialSteel extends MaterialMetalAlloy
{
    ...
    public MaterialSteel() {
        ...
        addExistingFlag(ModFlags.IMMERSIVEENGINEERING, BlockCategoryFlags.STORAGE_BLOCK, BlockCategoryFlags.SHEETMETAL_BLOCK, BlockCategoryFlags.SHEETMETAL_SLAB, BlockCategoryFlags.STAIRS, BlockCategoryFlags.SLAB);
        addFlags(BlockCategoryFlags.CRATE);
    }

    @Override
    protected BiFunction<IFlagType<?>, Integer, Integer> materialColorFunction() {
        return ((p, i) -> (0xff85888C));
    }
}
