...
public class MaterialMCDripstone extends MaterialStone {

    public MaterialMCDripstone() {
        super();
        this.name = "dripstone_block"; // Special Case as we need to override the deafult name assignment method
    ...
    {
        return IGBlockProperties.copy(Blocks.DRIPSTONE_BLOCK);
    }
}
