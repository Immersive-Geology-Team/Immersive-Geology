...
public class MaterialHighSpeedSteel extends MaterialMetalAlloy
{
    ...
    public MaterialHighSpeedSteel() {
        ...
        addFlags(ItemCategoryFlags.INGOT, ItemCategoryFlags.PLATE, ItemCategoryFlags.GEAR, ItemCategoryFlags.NUGGET,
                BlockCategoryFlags.STORAGE_BLOCK, BlockCategoryFlags.SLAB, BlockCategoryFlags.STAIRS, ItemCategoryFlags.DRILL_HEAD);
    }
    ...
    {
        return new DrillHeadProps(getName(), getItemTag(ItemCategoryFlags.INGOT), 3, 1, Tiers.NETHERITE, 21.0f, 10, 10000, () -> new ResourceLocation(IGLib.MODID, "item/colored/" + getName() + "/drill"));
    }
