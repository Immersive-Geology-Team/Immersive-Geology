...
public class IGMethodBuilder
{
	...
	public static IGChemicalMethod chemical(IGRecipeStage parentStage) { return new IGChemicalMethod(parentStage);}

	public static IGBloomeryMethod bloomery(IGRecipeStage parentStage) {return new IGBloomeryMethod(parentStage);}

	public static IGRoastingMethod roast(IGRecipeStage parentStage) {return new IGRoastingMethod(parentStage);}
