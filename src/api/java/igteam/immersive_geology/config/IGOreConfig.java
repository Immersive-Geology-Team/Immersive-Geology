...
public class IGOreConfig {
    ...
    public IGOreConfig(ForgeConfigSpec.Builder builder, String name, int defSize, int defMinY, int defMaxY, int defNumPerChunk, int chance)
    {
        builder.push(name);
        ...
        spawnChance = builder.comment("How likely it is to spawn per attempt (chance / 10000)").defineInRange("spawn_chance", chance, 0, 9999);
        builder.pop();
    }
}
