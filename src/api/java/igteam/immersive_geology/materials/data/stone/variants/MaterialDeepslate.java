...
public class MaterialDeepslate extends MaterialBaseStone {
    public MaterialDeepslate() {
        super("deepslate");
    }
    ...
    public ResourceLocation getTextureLocation(MaterialPattern pattern) {
        if(pattern instanceof BlockPattern){
            ...
            switch(b) {
                case block: case ore: return new ResourceLocation("minecraft", "block/deepslate");
        ...
        if(pattern instanceof ItemPattern){
            ...
            switch(i) {
                ...
                default: return new ResourceLocation("minecraft", "block/deepslate");
            }
        }
        return null;
    }
