...
public class IGArcSmeltingMethod extends IGProcessingMethod {
    ...
    public IGArcSmeltingMethod create(String method_name, TagKey<Item> input, int inputAmount, ItemStack output, @Nullable ItemStack iSlag, IngredientWithSize... additives){
        this.inputTag = input;
    ...
    public IGArcSmeltingMethod addAdditive(TagKey<Item> item, int count){
