...
public class IGCraftingMethod extends IGProcessingMethod {
    ...
    public IGCraftingMethod shapeless(Item result, int amount, TagKey<Item>... inputs) {
        this.result = result;
        this.amount = amount;
    ...
    public ResourceLocation getLocation() {
        ...
        return toRL(type + "/craft_" + inputLoc + "_" + Objects.requireNonNull(getResult().asItem().getRegistryName()).getPath());
    }
    ...
    public String getName() {
        ...
        return "craft_" + inputLoc + "_" + Objects.requireNonNull(getResult().asItem().getRegistryName()).getPath();
    }
