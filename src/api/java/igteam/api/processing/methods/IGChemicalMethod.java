...
public class IGChemicalMethod extends IGProcessingMethod {
    ...
    public void create(TagKey<Item> inputTag, int inputAmount, FluidTagInput primaryFluid, FluidTagInput secondaryFluid, ItemStack itemResult, FluidStack fluidResult, int time, int energy){
    ...
    public void create(String name, TagKey<Item> itemInput, int input_count, FluidTagInput primaryFluid, FluidTagInput secondaryFluid, ItemStack itemResult, FluidStack fluidResult, int time, int energy){
        methodName = name;
