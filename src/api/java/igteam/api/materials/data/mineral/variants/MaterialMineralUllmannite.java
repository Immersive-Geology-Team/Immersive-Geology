        ...
        new IGProcessingStage(this, IGStageDesignation.roasting) {
            ...
            protected void describe() {
                IRecipeBuilder.roast(this).create(
                        ...
                        MetalEnum.Nickel.getStack(ItemFamily.metal_oxide),
                        200, 2);
            }
        };
        ...
        new IGProcessingStage(this,IGStageDesignation.leeching) {
            ...
            protected void describe() {
                IRecipeBuilder.chemical(this).create(
                        ...
                        MetalEnum.Nickel.getItemTag(ItemFamily.metal_oxide), 1,
                        new FluidTagInput(FluidEnum.HydrochloricAcid.getFluidTag(FluidFamily.fluid), 250),
                        new FluidTagInput(FluidTags.WATER, 250),
                        ItemStack.EMPTY,
                        SlurryEnum.NICKEL.getType(FluidEnum.HydrochloricAcid).getFluidStack(FluidFamily.slurry, 250),
                        200, 51200);
                IRecipeBuilder.crystalize(this).create(
                        "slurry" + SlurryEnum.NICKEL.getType(FluidEnum.HydrochloricAcid).getName() + "_to_crystal",
                        MetalEnum.Nickel.getStack(ItemFamily.crystal),
                        SlurryEnum.NICKEL.getType(FluidEnum.HydrochloricAcid).getFluidTag(FluidFamily.slurry), 250,
                        300, 38400);
            }
        };
    }
