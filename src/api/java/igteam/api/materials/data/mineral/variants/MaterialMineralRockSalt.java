        ...
        new IGProcessingStage(this, IGStageDesignation.synthesis, "Brine and Hydroxide Production")
        {
            ...
            protected void describe(){
                ...
                IRecipeBuilder.chemical(this).create(
                        ...
                        getItemTag(ItemFamily.dust), 2,
                        new FluidTagInput(FluidTags.WATER, 125),
                        new FluidTagInput(FluidTags.WATER, 125),
                        ItemStack.EMPTY,
                        new FluidStack(FluidEnum.Brine.getFluid(FluidFamily.fluid), 250),
                        100, 12800);

                IRecipeBuilder.chemical(this).create(
                        "sodium_oxide_to_hydroxide",
                        MetalEnum.Sodium.getItemTag(ItemFamily.metal_oxide), 2,
                        new FluidTagInput(FluidTags.WATER, 125),
                        new FluidTagInput(FluidTags.WATER, 125),
                        ItemStack.EMPTY,
                        new FluidStack(FluidEnum.SodiumHydroxide.getFluid(FluidFamily.fluid), 250),
                        100, 12800);
            }
        };
        ...
        new IGProcessingStage(this,IGStageDesignation.synthesis, "Hydrochloric Production") {
            ...
            protected void describe() {
                IRecipeBuilder.chemical(this).create(
                        ...
                        new FluidStack(FluidEnum.HydrochloricAcid.getFluid(FluidFamily.fluid), 125),
                        100, 12800);
