        ...
        new IGProcessingStage(this, IGStageDesignation.blasting) {
            ...
            protected void describe() {
                IRecipeBuilder.blasting(this).create(
                        ...
                        MetalEnum.Lead.getStack(ItemFamily.ingot, 1));
            }
        };
        ...
        new IGProcessingStage(this, IGStageDesignation.refinement) {
            ...
            protected void describe() {
                IRecipeBuilder.arcSmelting(this).create("slag_"+getName() +"_to_metal_and_compound_dust",
                        getParentMaterial().getItemTag(ItemFamily.slag), 1,
                        MetalEnum.Lead.getStack(ItemFamily.ingot),
                        MetalEnum.Silver.getStack(ItemFamily.compound_dust),
                ...
                IRecipeBuilder.decompose(this).create("compound_dust_"+ MetalEnum.Silver.getName() + "_to_dust",
                        MetalEnum.Silver.getStack(ItemFamily.dust),
                        MetalEnum.Silver.getItemTag(ItemFamily.compound_dust), 1,
                        300, 153600);
            }
        };
