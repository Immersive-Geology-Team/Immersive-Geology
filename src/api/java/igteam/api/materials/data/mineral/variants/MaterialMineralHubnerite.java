        ...
        new IGProcessingStage(this,IGStageDesignation.extraction) { //TODO May need to have this broken into other stages, don't know which ones though.
            ...
            protected void describe() {
                ...
                IRecipeBuilder.chemical(this).create(
                        ...
                        SlurryEnum.MANGANESE.getType(FluidEnum.HydrochloricAcid).getFluidStack(FluidFamily.slurry, 250),
                        200, 51200);
        ...
        new IGProcessingStage(this, IGStageDesignation.refinement) {
            ...
            protected void describe() {
                ...
                IRecipeBuilder.chemical(this).create(
                        ...
                        null, 0,
                        new FluidTagInput(SlurryEnum.MANGANESE.getType(FluidEnum.HydrochloricAcid).getFluidTag(FluidFamily.slurry), 250),
                        new FluidTagInput(FluidEnum.SulfuricAcid.getFluidTag(FluidFamily.fluid), 250),
                        ItemStack.EMPTY,
                        SlurryEnum.MANGANESE.getType(FluidEnum.SulfuricAcid).getFluidStack(FluidFamily.slurry, 250),
                        200, 51200);

                IRecipeBuilder.crystalize(this).create(
                        "slurry" + SlurryEnum.MANGANESE.getType(FluidEnum.SulfuricAcid).getName() + "_to_crystal",
                        MetalEnum.Manganese.getStack(ItemFamily.crystal),
                        SlurryEnum.MANGANESE.getType(FluidEnum.SulfuricAcid).getFluidTag(FluidFamily.slurry), 250,
                        300, 38400);
            }
        };
    }
