    ...
    protected void setupProcessingStages() {
        ...
        new IGProcessingStage(this, IGStageDesignation.extraction) {
            ...
            protected void describe() {
                ...
                TagKey<Item> t = ItemTags.makeWrapperTag("forge:ores/aluminum");

                IRecipeBuilder.cutting(this).create(
                        t,
                        new FluidTagInput(FluidTags.WATER, 80),
                        StoneEnum.Stone.getStack(ItemFamily.ore_chunk, getParentMaterial(), 5)
        ...
        new IGProcessingStage(this, IGStageDesignation.purification) {
            ...
            protected void describe() {
                ...
                IRecipeBuilder.decompose(this).create(
                        ...
                        MetalEnum.Aluminum.getStack(ItemFamily.metal_oxide),
                        getItemTag(ItemFamily.crushed_ore), 1, 300, 153600);

                IRecipeBuilder.chemical(this).create(
                        "metal_oxide_" + getName() + "_to_compound_dust" ,
                        MetalEnum.Aluminum.getItemTag(ItemFamily.metal_oxide), 1,
                        new FluidTagInput(FluidEnum.SodiumHydroxide.getFluidTag(FluidFamily.fluid), 125),
                        new FluidTagInput(FluidTags.WATER, 125),
                        MetalEnum.Aluminum.getStack(ItemFamily.compound_dust, 1),
                ...
                IRecipeBuilder.chemical(this).create(
                        ...
                        MetalEnum.Aluminum.getItemTag(ItemFamily.compound_dust), 1,
                        new FluidTagInput(FluidEnum.HydrofluoricAcid.getFluidTag(FluidFamily.fluid), 125),
                        new FluidTagInput(FluidTags.WATER, 125),
                        MineralEnum.Cryolite.getStack(ItemFamily.dust, 1),
                        new FluidStack(Fluids.EMPTY, 250),
                        200,
                        51200);
                ...
                IRecipeBuilder.arcSmelting(this).create(
                                ...
                                MetalEnum.Aluminum.getItemTag(ItemFamily.metal_oxide), 1,
                                MetalEnum.Aluminum.getStack(ItemFamily.ingot),
                                MineralEnum.Cryolite.getStack(ItemFamily.dust),
                                new IngredientWithSize(IETags.coalCokeDust, 1),
                                new IngredientWithSize(MineralEnum.Cryolite.getItemTag(ItemFamily.dust), 1))
