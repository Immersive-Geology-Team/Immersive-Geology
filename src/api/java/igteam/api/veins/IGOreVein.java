...
public class IGOreVein {
    private Map<ITag.INamedTag<Item>, Float> veinContent;
    ...
    public IGOreVein addMineral(ITag.INamedTag<Item> mineral, int share) {
    ...
    public void recalculateOutputShares() {
        ...
        if (sharesSum != 0) {
            Map<ITag.INamedTag<Item>, Float> temp = new HashMap<>();
            for (ITag.INamedTag<Item> mineral : veinContent.keySet()) {
